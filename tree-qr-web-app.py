...
with st.form("tree_form"):
    ...
    tree_name = st.selectbox("Tree Name", [
        "Alstonia angustiloba", "Anisoptera costata", "Aquilaria malaccensis",
        "Ardisia elliptica", "Azadirachta indica", "Azara Microphylla",
        "Baeckea frutescens", "Barringtonia asiatica", "Barringtonia racemosa",
        "Baringtonia acutangula", "Buchanania arborescens", "Buchanania sessifolia",
        "Calophyllum inophyllum", "Callophyllum inophyllum", "Cassia javanica",
        "Casuarina equisetifolia", "Caesalpinia ferrea", "Cerbera manghas",
        "Cerbera odollam rubra", "Cinnamomum iners", "Coccoloba uvifera",
        "Cratoxylum cochinchinensis", "Cratoxylum chochinchinensis", "Cratoxylum formosum",
        "Cratoxylum fragrance", "Crescentia cujete", "Dalbergia latifolia",
        "Dillenia indica", "Dillenia suffruticosa", "Diospyros blancoi",
        "Diospyros buxifolia", "Diospyros discolor", "Dipterocarpus alatus",
        "Dipterocarpus baudi", "Dipterocarpus gracilis", "Dipterocarpus oblongifolius",
        "Dyera costulata", "Eleocarpus grandiflorus", "Eugenia formosanum",
        "Ficus lyrata", "Ficus microcarpa", "Ficus retusa",
        "Filicium decipiens", "Garcinia hombroniana", "Garcinia xanthochymus",
        "Gardenia carinata", "Gymnostoma rumphianum", "Heteropanax fragrans",
        "Hibiscus tiliaceus", "Hibiscus tiliaceus rubra", "Hopea ferrea",
        "Hopea odorata", "Jacaranda obtusifolia", "Khaya senegalensis",
        "Lagestromia indica", "Lagestromia speciosa", 
        "Leptospermum brachyandrum", "Libidibia Ferrea", "Licuala grandis",
        "Magnolia champaca", "Maniltoa browneoides", "Mangifera indica",
        "Melaleuca cajupati", "Melaleuca cajuputi", "Memecylon caeruleum",
        "Mesua ferrea", "Michelia champaka", "Millingtonia hortensis",
        "Millettia pinnata", "Mimusops elengi", "Neolamarckia cabamda",
        "Ormosia pinnata", "Pentaspadon motleyi", "Planchonella obovata",
        "Podocarpus macrophyllus", "Podocarpus polystachyus", "Podocarpus rumphii",
        "Pometia pinnata", "Pouteria sapota", "Pterocarpus indicus",
        "Quercus nigra", "Salix babylonica", "Samanea saman",
        "Saraca Indica", "Saraca thaipingensis", "Shorea roxburghii",
        "Spathodea campanulata", "Sterculia foetida", "Sterculia paviflora",
        "Swietenia marophylla", "Syzygium grande", "Syzygium polyanthum",
        "Syzygium spicata", "Tabebuia argentea", "Tabebuia rosea",
        "Terminalia calamansanai", "Terminalia catappa", "Terminalia Cattapa",
        "Terminalia superba", "Tristania obovata", "Tristaniopsis whiteana",
        "Unknown sp", "Mixed sp"
    ])
